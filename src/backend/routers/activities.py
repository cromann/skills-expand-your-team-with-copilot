...
def get_activities(
    ...
    - difficulty: Filter by difficulty level ('Beginner', 'Intermediate', 'Advanced', or 'all' for activities without difficulty)
    """
    ...
    if difficulty:
        if difficulty.lower() == "all":
            # "All" means activities without a difficulty field
